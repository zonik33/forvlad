            ...
            >
                ...
                <AccordionDetails style={{color: expanded === 'panel4' ? '#5E6976' : '#5E6976'}}>
                    <Typography>
                        ...
                        Для участия в акции Вам необходимо в период с «1» сентября 2024г. по «30» ноября 2024г.
                        приобрести лотерейные билеты «Мечталлион», «Лавина призов», «12 Добрых дел», «Великолепная 8»,
                        «Пятая скорость», «Трижды три», «Форсаж-75» на сумму не менее 300 рублем в отделениях Почты
                        ...
                        https://nloto-promo.ru/, укзазав номер мобильного телефона и приняв согласие на обработку
