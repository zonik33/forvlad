                            ...
                            <div className={'prizes-content-box2'}>
                                ...
                                <div className={'prizes-content-box-title-bot2'}>
                                    ...
                                    <p className={'how-center-p-text-first'}>
                                        ...
                                        билета в период с 01.08.2024 начала и до 30.09.25 завершения этапа регистрации.
                                    </p>

                                    <p className={'how-center-p-text'}>В акции участвуют билеты, купленные в отделении
                                        Почты России  с указанием<br></br>
                                        номера
                                        ...
                                        при совпадении номера мобильного телефона лотерейный билет
