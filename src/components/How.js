                            ...
                            <div className={'prizes-content-box2'}>
                                ...
                                <div className={'prizes-content-box-title-bot2'}>
                                    ...
                                    <p className={'how-center-p-text-first'}>
                                        Добавьте номер приобретенного лотерейного
                                        билета в период с Х-дата начала и до Х-дата завершения этапа регистрации.
                                    </p>

                                    <p className={'how-center-p-text'}>В акции участвуют билеты, купленные на сайте
                                        «Национальная Лотерея», <br></br>а также в отделении Почты России с указанием
                                        номера
                                        мобильного телефона, то регистрировать такой лотерейный билет не нужно.
                                        После регистрации и/или авторизации на промо-сайте акции
                                        при совпадении номера мобильного <br></br>телефона лотерейный билет
                                        автоматически зарегистрируется в акции и будет отображен
