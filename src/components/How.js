                        ...
                        <div className={'prizes-content-box2'}>
                            ...
                            <div className={'prizes-content-box-title-bot2'}>Зарегистрируйтесь на сайте <a
                                ...
                                <p className={'how-center-p-text'}>* В Акции участвуют билеты, купленные на сайте
                                    ...
                                    <br></br>а также в отделении Почты России <a
                                         className={'text-nloto-blue'}>с указанием номера мобильного
                                        телефона</a>,
                                    то регистрировать такой лотерейный билет не нужно. После регистрации и/или
                                    авторизации на промо-сайте акции при совпадении номера мобильного телефона
                                    лотерейный билет автоматически зарегистрируется в акции и будет отображен в вашем
                                    личном кабинете</p>
                            </div>
                        </div>
